...
export const useMemory = () => {
    ...
    useEffect(() => {
        try {
            ...
            logDev('error', "Failed to parse memory from localStorage", e);
        }
    }, []);
    ...
    useEffect(() => {
        try {
            ...
            logDev('error', "Failed to save LTM to localStorage", e);
        }
    }, [ltm]);
    ...
    useEffect(() => {
        try {
            ...
            logDev('error', "Failed to save Code Memory to localStorage", e);
        }
    }, [codeMemory]);
    ...
    useEffect(() => {
        ...
        if (userProfile.name !== null) {
            try {
                ...
                logDev('error', "Failed to save user profile to localStorage", e);
            }
        }
    }, [userProfile]);
